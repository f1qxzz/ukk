                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="fw-600"><?= htmlspecialchars($r['nama_pengguna']) ?></div>
                                    </td>
                                    <td><?= htmlspecialchars($r['username']) ?></td>
                                    <td><?= htmlspecialchars($r['email']??'—') ?></td>
                                    <td><span
                                            class="badge <?= $r['level']==='admin'?'badge-rust':'badge-muted' ?>"><?= ucfirst($r['level']) ?></span>
                                    </td>
                                    <td>
                                        <div style="display:flex;gap:6px">
                                            <a href="?edit=<?= $r['id_pengguna'] ?>"
                                                class="btn btn-ghost btn-sm">Edit</a>
                                            <button class="btn btn-ghost btn-sm"
                                                onclick="showReset(<?= $r['id_pengguna'] ?>,'<?= htmlspecialchars($r['nama_pengguna']) ?>')">Reset
                                                PW</button>
                ...
                <div class="modal-body">
                    <div class="form-grid">
                        <div class="form-group"><label class="form-label">Nama Lengkap *</label><input
                                name="nama_pengguna" class="form-control" required></div>
                        ...
                        <div class="form-group form-full"><label class="form-label">Email</label><input name="email"
        ...
        <div class="modal">
            ...
            <form method="POST">
                ...
                <div class="modal-body">
                    <div class="form-grid">
                        <div class="form-group"><label class="form-label">Nama Lengkap *</label><input
                                name="nama_pengguna" class="form-control"
                                value="<?= htmlspecialchars($editUser['nama_pengguna']) ?>" required></div>
                        <div class="form-group"><label class="form-label">Level</label>
                            <select name="level" class="form-control">
                                <option value="petugas" <?= $editUser['level']==='petugas'?'selected':'' ?>>Petugas
                                </option>
                        ...
                        <div class="form-group form-full"><label class="form-label">Email</label><input name="email"
                                ...
                                value="<?= htmlspecialchars($editUser['email']??'') ?>"></div>
                    </div>
                </div>
                <div class="modal-footer">
