...
<head>
    ...
    .id-card-banner {
        height: 80px;
        background: linear-gradient(135deg, var(--navy) 0%, #3b1d8a 50%, var(--teal) 100%);
        position: relative;
    }
                            ...
                            <div class="id-card-body">
                                ...
                                <div class="profil-role-badge">
                                    <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" stroke="none">
                                        <path
                                            d="M12 1l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-2.01L12 1z" />
                                    </svg>
