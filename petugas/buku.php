...
if (isset($_POST['edit'])) {
    ...
    if (!$uploadGagal) {
        ...
        $s->bind_param("sississisi", $judul, $id_kat, $peng, $nerbit, $tahun, $isbn, $desk, $stok, $status, $newCover, $id);
    ...
    <main class="content">
      ...
      <div class="card">
        <form method="GET" class="filter-bar">
          ...
          <?php if ($search||$filter_kat): ?><a href="buku.php" class="btn btn-ghost btn-sm">Reset</a><?php endif; ?>
        </form>
        ...
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
                <th>#</th><th>Cover</th><th>Judul Buku</th><th>Pengarang</th>
                <th>Kategori</th><th>Tahun</th><th>Stok</th><th>Status</th><th>Aksi</th>
              </tr>
            </thead>
            <tbody>
      ...
      <div class="modal-body">
        <div class="form-grid">
          ...
          <div class="form-group">
            ...
            <input type="file" id="addCoverInput" name="cover" accept=".jpg,.jpeg,.png" style="display:none"
              onchange="previewCover(this,'addCoverPreview','addCoverFilename')">
          </div>
          <div class="form-group form-full">
      ...
      <div class="modal-body">
        <div class="form-grid">
          ...
          <div class="form-group">
            ...
            <input type="file" id="editCoverInput" name="cover" accept=".jpg,.jpeg,.png" style="display:none"
