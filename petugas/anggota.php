            ...
            <main class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2><?= $editMember?'Edit Anggota':'Tambah Anggota Baru' ?></h2>
                    </div>
                    <div class="card-body">
                        <form method="POST">
                            <?php if($editMember): ?><input type="hidden" name="id_anggota"
                                value="<?= $editMember['id_anggota'] ?>"><?php endif; ?>
                            <div class="form-row">
                            ...
                            <?php else: ?>
                            <div class="form-row">
                                <div class="form-group"><label>Password Baru <small>(kosongkan jika tidak
                                            diubah)</small></label>
                            ...
                            <div style="display:flex;gap:10px;">
                                <button type="submit" name="<?= $editMember?'edit':'add' ?>"
                                    class="btn btn-primary"><?= $editMember?'Update':'Tambah' ?></button>
                                <?php if($editMember): ?><a href="anggota.php"
                                    class="btn btn-secondary">Batal</a><?php endif; ?>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="search-box">
                            <form method="GET" style="display:flex;gap:10px;width:100%;">
                                <input type="text" name="search" class="form-control"
                                    placeholder="Cari nama, NIS, kelas..." value="<?= htmlspecialchars($search) ?>">
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span
                                                class="badge <?= $r['status']==='aktif'?'badge-success':'badge-danger' ?>"><?= ucfirst($r['status']) ?></span>
                                        </td>
                ...
                function confirmDelete() {
                    return confirm('Hapus anggota ini?');
                }
                </script>
